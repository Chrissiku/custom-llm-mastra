...
var LIST_STORED_PROMPT_BLOCKS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  ...
  responseType: "json",
  queryParamSchema: chunkXM2YJ3NM_cjs.listStoredPromptBlocksQuerySchema,
  responseSchema: chunkXM2YJ3NM_cjs.listStoredPromptBlocksResponseSchema,
  ...
  handler: async ({ mastra, page, perPage, orderBy, status, authorId, metadata }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error listing stored prompt blocks");
    }
  }
});
var GET_STORED_PROMPT_BLOCK_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  ...
  responseType: "json",
  pathParamSchema: chunkXM2YJ3NM_cjs.storedPromptBlockIdPathParams,
  queryParamSchema: chunkEES2ZZGL_cjs.statusQuerySchema,
  responseSchema: chunkXM2YJ3NM_cjs.getStoredPromptBlockResponseSchema,
  ...
  handler: async ({ mastra, storedPromptBlockId, status }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error getting stored prompt block");
    }
  }
});
var CREATE_STORED_PROMPT_BLOCK_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  ...
  path: "/stored/prompt-blocks",
  responseType: "json",
  bodySchema: chunkXM2YJ3NM_cjs.createStoredPromptBlockBodySchema,
  responseSchema: chunkXM2YJ3NM_cjs.createStoredPromptBlockResponseSchema,
  ...
  handler: async ({
    ...
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error creating stored prompt block");
    }
  }
});
var UPDATE_STORED_PROMPT_BLOCK_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  ...
  responseType: "json",
  pathParamSchema: chunkXM2YJ3NM_cjs.storedPromptBlockIdPathParams,
  bodySchema: chunkXM2YJ3NM_cjs.updateStoredPromptBlockBodySchema,
  responseSchema: chunkXM2YJ3NM_cjs.updateStoredPromptBlockResponseSchema,
  ...
  handler: async ({
    ...
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error updating stored prompt block");
    }
  }
});
var DELETE_STORED_PROMPT_BLOCK_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  ...
  responseType: "json",
  pathParamSchema: chunkXM2YJ3NM_cjs.storedPromptBlockIdPathParams,
  responseSchema: chunkXM2YJ3NM_cjs.deleteStoredPromptBlockResponseSchema,
  ...
  handler: async ({ mastra, storedPromptBlockId }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error deleting stored prompt block");
    }
  }
});
