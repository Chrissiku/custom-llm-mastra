...
var groqFailedResponseHandler = chunkHERDIEC2_cjs.createJsonErrorResponseHandler({
...
var GroqChatLanguageModel = class {
  ...
  getArgs({
    ...
    const groqOptions = chunkHERDIEC2_cjs.parseProviderOptions({
      provider: "groq",
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunkHERDIEC2_cjs.postJsonToApi({
      ...
      failedResponseHandler: groqFailedResponseHandler,
      successfulResponseHandler: chunkHERDIEC2_cjs.createEventSourceResponseHandler(groqChatChunkSchema),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
    const { messages: rawPrompt, ...rawSettings } = args;
          ...
          transform(chunk, controller) {
            ...
            if (delta.tool_calls != null) {
              for (const toolCallDelta of delta.tool_calls) {
                  ...
                  if (((_f = toolCall2.function) == null ? void 0 : _f.name) != null && ((_g = toolCall2.function) == null ? void 0 : _g.arguments) != null) {
                    ...
                    if (chunkHERDIEC2_cjs.isParsableJson(toolCall2.function.arguments)) {
                      controller.enqueue({
                        type: "tool-call",
                        toolCallType: "function",
                        toolCallId: (_h = toolCall2.id) != null ? _h : chunkHERDIEC2_cjs.generateId(),
                        toolName: toolCall2.function.name,
                ...
                if (((_m = toolCall.function) == null ? void 0 : _m.name) != null && ((_n = toolCall.function) == null ? void 0 : _n.arguments) != null && chunkHERDIEC2_cjs.isParsableJson(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-call",
                    toolCallType: "function",
                    toolCallId: (_o = toolCall.id) != null ? _o : chunkHERDIEC2_cjs.generateId(),
                    toolName: toolCall.function.name,
                    args: toolCall.function.arguments
                  });
...
function createGroq(options = {}) {
  var _a;
  const baseURL = (_a = chunkHERDIEC2_cjs.withoutTrailingSlash(options.baseURL)) != null ? _a : "https://api.groq.com/openai/v1";
  const getHeaders = () => ({
  ...
  provider.textEmbeddingModel = (modelId) => {
    throw new chunkHERDIEC2_cjs.NoSuchModelError({ modelId, modelType: "textEmbeddingModel" });
  };
...
exports.groq = groq;
//# sourceMappingURL=dist-6SY6NNDU.cjs.map
//# sourceMappingURL=dist-6SY6NNDU.cjs.map