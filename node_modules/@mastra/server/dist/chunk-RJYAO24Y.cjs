...
var LIST_PROCESSORS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/processors",
  responseType: "json",
  responseSchema: chunk4P237WJB_cjs.listProcessorsResponseSchema,
  ...
  handler: async ({ mastra }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error getting processors");
    }
  }
});
var GET_PROCESSOR_BY_ID_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/processors/:processorId",
  responseType: "json",
  pathParamSchema: chunk4P237WJB_cjs.processorIdPathParams,
  responseSchema: chunk4P237WJB_cjs.serializedProcessorDetailSchema,
  ...
  handler: async ({ mastra, processorId }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error getting processor");
    }
  }
});
var EXECUTE_PROCESSOR_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
  path: "/processors/:processorId/execute",
  responseType: "json",
  pathParamSchema: chunk4P237WJB_cjs.processorIdPathParams,
  bodySchema: chunk4P237WJB_cjs.executeProcessorBodySchema,
  responseSchema: chunk4P237WJB_cjs.executeProcessorResponseSchema,
  ...
  handler: async ({ mastra, processorId, ...bodyParams }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error executing processor");
    }
  }
});
...
//# sourceMappingURL=chunk-RJYAO24Y.cjs.map
//# sourceMappingURL=chunk-RJYAO24Y.cjs.map