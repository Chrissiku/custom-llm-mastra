...
async function getAgentCardByIdHandler({
  ...
  const agentCard = {
    ...
    description: chunkWC4OPIB4_cjs.convertInstructionsToString(instructions),
    url: executionUrl,
    provider,
    version,
    capabilities: {
...
var GET_AGENT_CARD_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/.well-known/:agentId/agent-card.json",
  responseType: "json",
  pathParamSchema: chunk6N5NDQVM_cjs.a2aAgentIdPathParams,
  responseSchema: chunk6N5NDQVM_cjs.agentCardResponseSchema,
...
var AGENT_EXECUTION_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
  path: "/a2a/:agentId",
  responseType: "json",
  pathParamSchema: chunk6N5NDQVM_cjs.a2aAgentIdPathParams,
  bodySchema: chunk6N5NDQVM_cjs.agentExecutionBodySchema,
  responseSchema: chunk6N5NDQVM_cjs.agentExecutionResponseSchema,
...
//# sourceMappingURL=chunk-ZWKZK4WO.cjs.map
//# sourceMappingURL=chunk-ZWKZK4WO.cjs.map