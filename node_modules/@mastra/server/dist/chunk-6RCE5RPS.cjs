...
var LIST_PROCESSOR_PROVIDERS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  ...
  handler: async ({ mastra }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error listing processor providers");
    }
  }
});
var GET_PROCESSOR_PROVIDER_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  ...
  handler: async ({ mastra, providerId }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error getting processor provider");
    }
  }
});
...
//# sourceMappingURL=chunk-6RCE5RPS.cjs.map
//# sourceMappingURL=chunk-6RCE5RPS.cjs.map