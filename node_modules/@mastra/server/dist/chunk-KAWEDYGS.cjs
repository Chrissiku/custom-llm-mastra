...
var LIST_MCP_SERVERS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/mcp/v0/servers",
  responseType: "json",
  queryParamSchema: chunkDCWP744F_cjs.listMcpServersQuerySchema,
  responseSchema: chunkDCWP744F_cjs.listMcpServersResponseSchema,
...
var GET_MCP_SERVER_DETAIL_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/mcp/v0/servers/:id",
  responseType: "json",
  pathParamSchema: chunkDCWP744F_cjs.mcpServerDetailPathParams,
  queryParamSchema: chunkDCWP744F_cjs.getMcpServerDetailQuerySchema,
  responseSchema: chunkDCWP744F_cjs.serverDetailSchema,
...
var LIST_MCP_SERVER_TOOLS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/mcp/:serverId/tools",
  responseType: "json",
  pathParamSchema: chunkDCWP744F_cjs.mcpServerIdPathParams,
  responseSchema: chunkDCWP744F_cjs.listMcpServerToolsResponseSchema,
...
var GET_MCP_SERVER_TOOL_DETAIL_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/mcp/:serverId/tools/:toolId",
  responseType: "json",
  pathParamSchema: chunkDCWP744F_cjs.mcpServerToolPathParams,
  responseSchema: chunkDCWP744F_cjs.mcpToolInfoSchema,
...
var EXECUTE_MCP_SERVER_TOOL_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
  path: "/mcp/:serverId/tools/:toolId/execute",
  responseType: "json",
  pathParamSchema: chunkDCWP744F_cjs.mcpServerToolPathParams,
  bodySchema: chunkDCWP744F_cjs.executeToolBodySchema,
  responseSchema: chunkDCWP744F_cjs.executeToolResponseSchema,
...
var MCP_HTTP_TRANSPORT_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "ALL",
...
var MCP_SSE_TRANSPORT_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "ALL",
...
var MCP_SSE_MESSAGES_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
...
//# sourceMappingURL=chunk-KAWEDYGS.cjs.map
//# sourceMappingURL=chunk-KAWEDYGS.cjs.map