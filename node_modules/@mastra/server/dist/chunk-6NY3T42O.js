...
var responseTextFormatJsonObjectSchema = z.object({
  type: z.literal("json_object").describe("Requests JSON object output compatibility for the response")
});
var responseTextFormatJsonSchemaSchema = z.object({
...
var responseOutputTextSchema = z.object({
  type: z.literal("output_text"),
  text: z.string(),
  annotations: z.array(z.unknown()).optional(),
  logprobs: z.array(z.unknown()).optional()
});
var responseInputTextContentSchema = z.object({
  type: z.literal("input_text"),
  text: z.string()
});
var conversationMessageContentSchema = z.union([responseInputTextContentSchema, responseOutputTextSchema]);
var responseOutputMessageSchema = z.object({
  id: z.string(),
...
var responseOutputFunctionCallSchema = z.object({
  id: z.string(),
...
var responseOutputFunctionCallOutputSchema = z.object({
  id: z.string(),
  type: z.literal("function_call_output"),
  call_id: z.string(),
  output: z.string()
});
var responseUsageSchema = z.object({
...
var responseToolSchema = z.object({
  type: z.literal("function"),
  name: z.string(),
  description: z.string().optional(),
  parameters: z.unknown().optional()
});
var responseOutputItemSchema = z.union([
  responseOutputMessageSchema,
  responseOutputFunctionCallSchema,
  responseOutputFunctionCallOutputSchema
]);
var conversationItemMessageSchema = z.object({
  id: z.string(),
  type: z.literal("message"),
...
var conversationItemSchema = z.union([
  conversationItemMessageSchema,
  responseOutputFunctionCallSchema,
  responseOutputFunctionCallOutputSchema
]);
var responseObjectSchema = z.object({
  id: z.string(),
