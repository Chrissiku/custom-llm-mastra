...
var LIST_AGENT_VERSIONS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/stored/agents/:agentId/versions",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkYG3JPRRY_cjs.agentVersionPathParams,
  queryParamSchema: chunk2U535WWQ_cjs.listVersionsQuerySchema,
  responseSchema: chunkYG3JPRRY_cjs.listVersionsResponseSchema,
...
var CREATE_AGENT_VERSION_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
  path: "/stored/agents/:agentId/versions",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkYG3JPRRY_cjs.agentVersionPathParams,
  bodySchema: chunk2U535WWQ_cjs.createVersionBodySchema,
  responseSchema: chunkYG3JPRRY_cjs.createVersionResponseSchema,
...
var GET_AGENT_VERSION_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/stored/agents/:agentId/versions/:versionId",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkYG3JPRRY_cjs.versionIdPathParams,
  responseSchema: chunkYG3JPRRY_cjs.getVersionResponseSchema,
...
var ACTIVATE_AGENT_VERSION_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
  path: "/stored/agents/:agentId/versions/:versionId/activate",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkYG3JPRRY_cjs.versionIdPathParams,
  responseSchema: chunk2U535WWQ_cjs.activateVersionResponseSchema,
...
var RESTORE_AGENT_VERSION_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
  path: "/stored/agents/:agentId/versions/:versionId/restore",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkYG3JPRRY_cjs.versionIdPathParams,
  responseSchema: chunkYG3JPRRY_cjs.restoreVersionResponseSchema,
...
var DELETE_AGENT_VERSION_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "DELETE",
  path: "/stored/agents/:agentId/versions/:versionId",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkYG3JPRRY_cjs.versionIdPathParams,
  responseSchema: chunk2U535WWQ_cjs.deleteVersionResponseSchema,
...
var COMPARE_AGENT_VERSIONS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/stored/agents/:agentId/versions/compare",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunkYG3JPRRY_cjs.agentVersionPathParams,
  queryParamSchema: chunk2U535WWQ_cjs.compareVersionsQuerySchema,
  responseSchema: chunkYG3JPRRY_cjs.compareVersionsResponseSchema,
...
//# sourceMappingURL=chunk-JYST3GVF.cjs.map
//# sourceMappingURL=chunk-JYST3GVF.cjs.map