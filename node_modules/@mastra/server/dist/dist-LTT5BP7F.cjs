...
var OpenAICompatibleChatLanguageModel = class {
  ...
  constructor(modelId, settings, config) {
    ...
    this.failedResponseHandler = chunkHERDIEC2_cjs.createJsonErrorResponseHandler(errorStructure);
...
var OpenAICompatibleImageModel = class {
  ...
  async doGenerate({
    ...
    const { value: response, responseHeaders } = await chunkHERDIEC2_cjs.postJsonToApi({
      ...
      failedResponseHandler: chunkHERDIEC2_cjs.createJsonErrorResponseHandler(
...
function createXai(options = {}) {
  var _a;
  const baseURL = chunkHERDIEC2_cjs.withoutTrailingSlash(
...
exports.xai = xai;
//# sourceMappingURL=dist-LTT5BP7F.cjs.map
//# sourceMappingURL=dist-LTT5BP7F.cjs.map