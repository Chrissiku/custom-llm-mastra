...
function handleWorkspaceError(error, defaultMessage) {
  ...
  return chunkB34S64RC_cjs.handleError(error, defaultMessage);
}
...
var LIST_WORKSPACES_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/workspaces",
  responseType: "json",
...
var GET_WORKSPACE_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
...
var WORKSPACE_FS_READ_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
...
var WORKSPACE_FS_WRITE_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
...
var WORKSPACE_FS_LIST_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
...
var WORKSPACE_FS_DELETE_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "DELETE",
...
var WORKSPACE_FS_MKDIR_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
...
var WORKSPACE_FS_STAT_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
...
var WORKSPACE_SEARCH_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
...
var WORKSPACE_INDEX_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
...
var WORKSPACE_LIST_SKILLS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
...
var WORKSPACE_GET_SKILL_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
...
var WORKSPACE_LIST_SKILL_REFERENCES_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
...
var WORKSPACE_GET_SKILL_REFERENCE_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
...
var WORKSPACE_SEARCH_SKILLS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
...
var WORKSPACE_SKILLS_SH_SEARCH_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  ...
  handler: async ({ q, limit }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error searching skills");
    }
  }
});
var WORKSPACE_SKILLS_SH_POPULAR_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  ...
  handler: async ({ limit, offset }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error fetching popular skills");
    }
  }
});
...
var WORKSPACE_SKILLS_SH_PREVIEW_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  ...
  handler: async ({ owner, repo, path: skillName }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error fetching skill preview");
    }
  }
});
var WORKSPACE_SKILLS_SH_INSTALL_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
  ...
  handler: async ({ mastra, workspaceId, owner, repo, skillName, mount }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error installing skill");
    }
  }
});
var WORKSPACE_SKILLS_SH_REMOVE_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
  ...
  handler: async ({ mastra, workspaceId, skillName }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error removing skill");
    }
  }
});
var WORKSPACE_SKILLS_SH_UPDATE_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
  ...
  handler: async ({ mastra, workspaceId, skillName }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error updating skills");
    }
  }
});
...
//# sourceMappingURL=chunk-O5GBRVCT.cjs.map
//# sourceMappingURL=chunk-O5GBRVCT.cjs.map