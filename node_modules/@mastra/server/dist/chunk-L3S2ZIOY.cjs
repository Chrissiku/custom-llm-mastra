...
var LIST_MCP_CLIENT_VERSIONS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/stored/mcp-clients/:mcpClientId/versions",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunk22JIX4IH_cjs.mcpClientVersionPathParams,
  queryParamSchema: chunk22JIX4IH_cjs.listMCPClientVersionsQuerySchema,
  responseSchema: chunk22JIX4IH_cjs.listMCPClientVersionsResponseSchema,
  ...
  handler: async ({ mastra, mcpClientId, page, perPage, orderBy }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error listing MCP client versions");
    }
  }
});
var CREATE_MCP_CLIENT_VERSION_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
  path: "/stored/mcp-clients/:mcpClientId/versions",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunk22JIX4IH_cjs.mcpClientVersionPathParams,
  bodySchema: chunk22JIX4IH_cjs.createMCPClientVersionBodySchema,
  responseSchema: chunk22JIX4IH_cjs.createMCPClientVersionResponseSchema,
  ...
  handler: async ({ mastra, mcpClientId, changeMessage }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error creating MCP client version");
    }
  }
});
var GET_MCP_CLIENT_VERSION_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/stored/mcp-clients/:mcpClientId/versions/:versionId",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunk22JIX4IH_cjs.mcpClientVersionIdPathParams,
  responseSchema: chunk22JIX4IH_cjs.getMCPClientVersionResponseSchema,
  ...
  handler: async ({ mastra, mcpClientId, versionId }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error getting MCP client version");
    }
  }
});
var ACTIVATE_MCP_CLIENT_VERSION_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
  path: "/stored/mcp-clients/:mcpClientId/versions/:versionId/activate",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunk22JIX4IH_cjs.mcpClientVersionIdPathParams,
  responseSchema: chunk22JIX4IH_cjs.activateMCPClientVersionResponseSchema,
  ...
  handler: async ({ mastra, mcpClientId, versionId }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error activating MCP client version");
    }
  }
});
var RESTORE_MCP_CLIENT_VERSION_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
  path: "/stored/mcp-clients/:mcpClientId/versions/:versionId/restore",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunk22JIX4IH_cjs.mcpClientVersionIdPathParams,
  responseSchema: chunk22JIX4IH_cjs.restoreMCPClientVersionResponseSchema,
  ...
  handler: async ({ mastra, mcpClientId, versionId }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error restoring MCP client version");
    }
  }
});
var DELETE_MCP_CLIENT_VERSION_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "DELETE",
  path: "/stored/mcp-clients/:mcpClientId/versions/:versionId",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunk22JIX4IH_cjs.mcpClientVersionIdPathParams,
  responseSchema: chunk22JIX4IH_cjs.deleteMCPClientVersionResponseSchema,
  ...
  handler: async ({ mastra, mcpClientId, versionId }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error deleting MCP client version");
    }
  }
});
var COMPARE_MCP_CLIENT_VERSIONS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/stored/mcp-clients/:mcpClientId/versions/compare",
  requiresAuth: true,
  responseType: "json",
  pathParamSchema: chunk22JIX4IH_cjs.mcpClientVersionPathParams,
  queryParamSchema: chunk22JIX4IH_cjs.compareMCPClientVersionsQuerySchema,
  responseSchema: chunk22JIX4IH_cjs.compareMCPClientVersionsResponseSchema,
  ...
  handler: async ({ mastra, mcpClientId, from, to }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error comparing MCP client versions");
    }
  }
});
...
//# sourceMappingURL=chunk-L3S2ZIOY.cjs.map
//# sourceMappingURL=chunk-L3S2ZIOY.cjs.map