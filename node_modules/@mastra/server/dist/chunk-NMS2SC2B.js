  ...
  "../../node_modules/.pnpm/ajv@8.18.0/node_modules/ajv/dist/compile/validate/keyword.js"(exports$1) {
    ...
    function funcKeywordCode(cxt, def) {
      ...
      function reportErrs(errors) {
        var _a22;
        gen.if((0, codegen_1.not)((_a22 = def.valid) !== null && _a22 !== void 0 ? _a22 : valid), errors);
      }
    }
...
// ../schema-compat/dist/chunk-N4QSZBUR.js
var import_json_schema_traverse2 = __toESM(require_json_schema_traverse());
var TARGET_MAP = {
...
function convertToJsonSchema(zodSchema2, options) {
  ...
  const jsonSchema2 = esm_default(zodSchema2, {
    $refStrategy: "none",
    target
  });
  (0, import_json_schema_traverse2.default)(jsonSchema2, {
    cb: {
      pre: (schema) => {
...
function toStandardSchema4(zodSchema2, adapterOptions = {}) {
  ...
  const jsonSchemaConverter = {
    input: (options) => {
      return convertToJsonSchema2(zodSchema2, options, adapterOptions);
    },
    output: (options) => {
      return convertToJsonSchema2(zodSchema2, options, adapterOptions);
    }
...
function jsonSchemaOverride(ctx) {
  const zodSchema2 = ctx.zodSchema;
  ...
  if (zodSchema2) {
    if (zodSchema2?.type === "date") {
      ctx.jsonSchema.type = "string";
      ctx.jsonSchema.format = "date-time";
    } else if (zodSchema2?.type === "object" && zodSchema2._zod?.def?.catchall?.type === "unknown") {
...
function standardSchemaToJSONSchema(schema, options = {}) {
  ...
  jsonSchema2 = JSON.parse(JSON.stringify(jsonSchema2));
  return jsonSchema2;
}
...
var zodToJsonSchema22 = (schema, options) => {
  ...
  const main = parseDef2(schema._def, name17 === void 0 ? refs : {
    ...refs,
...
var __export = (target, all) => {
  for (var name17 in all)
    __defProp22(target, name17, { get: all[name17], enumerable: true });
};
...
__toESM(require_json_schema_traverse());
__toESM(require_json_schema_traverse());
...
function schemaToJsonSchema(schema) {
  const standardSchema = toStandardSchema$1(schema);
