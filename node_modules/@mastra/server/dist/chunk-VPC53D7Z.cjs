...
var LIST_STORED_WORKSPACES_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/stored/workspaces",
  responseType: "json",
  queryParamSchema: chunkWV5LJP6Y_cjs.listStoredWorkspacesQuerySchema,
  responseSchema: chunkWV5LJP6Y_cjs.listStoredWorkspacesResponseSchema,
  ...
  handler: async ({ mastra, page, perPage, orderBy, authorId, metadata }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error listing stored workspaces");
    }
  }
});
var GET_STORED_WORKSPACE_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/stored/workspaces/:storedWorkspaceId",
  responseType: "json",
  pathParamSchema: chunkWV5LJP6Y_cjs.storedWorkspaceIdPathParams,
  responseSchema: chunkWV5LJP6Y_cjs.getStoredWorkspaceResponseSchema,
  ...
  handler: async ({ mastra, storedWorkspaceId }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error getting stored workspace");
    }
  }
});
var CREATE_STORED_WORKSPACE_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
  path: "/stored/workspaces",
  responseType: "json",
  bodySchema: chunkWV5LJP6Y_cjs.createStoredWorkspaceBodySchema,
  responseSchema: chunkWV5LJP6Y_cjs.createStoredWorkspaceResponseSchema,
  ...
  handler: async ({
    ...
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error creating stored workspace");
    }
  }
});
var UPDATE_STORED_WORKSPACE_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "PATCH",
  path: "/stored/workspaces/:storedWorkspaceId",
  responseType: "json",
  pathParamSchema: chunkWV5LJP6Y_cjs.storedWorkspaceIdPathParams,
  bodySchema: chunkWV5LJP6Y_cjs.updateStoredWorkspaceBodySchema,
  responseSchema: chunkWV5LJP6Y_cjs.updateStoredWorkspaceResponseSchema,
  ...
  handler: async ({
    ...
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error updating stored workspace");
    }
  }
});
var DELETE_STORED_WORKSPACE_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "DELETE",
  path: "/stored/workspaces/:storedWorkspaceId",
  responseType: "json",
  pathParamSchema: chunkWV5LJP6Y_cjs.storedWorkspaceIdPathParams,
  responseSchema: chunkWV5LJP6Y_cjs.deleteStoredWorkspaceResponseSchema,
  ...
  handler: async ({ mastra, storedWorkspaceId }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error deleting stored workspace");
    }
  }
});
...
//# sourceMappingURL=chunk-VPC53D7Z.cjs.map
//# sourceMappingURL=chunk-VPC53D7Z.cjs.map