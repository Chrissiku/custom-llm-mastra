export declare const CREATE_CONVERSATION_ROUTE: import("../server-adapter").ServerRoute<{
    agent_id: string;
...
}, import("zod/v4/core").$strip>>, "POST", "/v1/conversations">;
export declare const GET_CONVERSATION_ROUTE: import("../server-adapter").ServerRoute<{
...
}, import("zod/v4/core").$strip>>, "GET", "/v1/conversations/:conversationId">;
export declare const GET_CONVERSATION_ITEMS_ROUTE: import("../server-adapter").ServerRoute<{
    conversationId: string;
}, {
    object: "list";
    data: ({
...
}, import("zod/v4/core").$strip>>, "GET", "/v1/conversations/:conversationId/items">;
export declare const DELETE_CONVERSATION_ROUTE: import("../server-adapter").ServerRoute<{
    conversationId: string;
}, {
    id: string;
