...
function protocolExternalResolver({ exclude = ["node:"] } = {}) {
  return {
    ...
    resolveId(id) {
      if (!chunkQTRSKNOJ_cjs.isExternalProtocolImport(id, exclude)) {
        return null;
      }
      return {
        id,
...
function subpathExternalsResolver(externals) {
  return {
    ...
    resolveId(id) {
      ...
      const isPartOfExternals = externals.some((external) => chunkQTRSKNOJ_cjs.isDependencyPartOfPackage(id, external));
...
//# sourceMappingURL=chunk-4WS47OHX.cjs.map
//# sourceMappingURL=chunk-4WS47OHX.cjs.map