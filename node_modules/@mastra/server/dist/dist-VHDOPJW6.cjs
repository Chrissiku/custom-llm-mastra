...
var anthropicFailedResponseHandler = chunkHERDIEC2_cjs.createJsonErrorResponseHandler({
...
var AnthropicMessagesLanguageModel = class {
  ...
  async getArgs({
    ...
    const anthropicOptions = chunkHERDIEC2_cjs.parseProviderOptions({
      provider: "anthropic",
      providerOptions,
  ...
  async getHeaders({
    ...
    return chunkHERDIEC2_cjs.combineHeaders(
...
function createAnthropic(options = {}) {
  var _a;
  const baseURL = (_a = chunkHERDIEC2_cjs.withoutTrailingSlash(options.baseURL)) != null ? _a : "https://api.anthropic.com/v1";
  const getHeaders = () => ({
    "anthropic-version": "2023-06-01",
    "x-api-key": chunkHERDIEC2_cjs.loadApiKey({
...
//# sourceMappingURL=dist-VHDOPJW6.cjs.map
//# sourceMappingURL=dist-VHDOPJW6.cjs.map