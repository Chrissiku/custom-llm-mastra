...
async function upsertVectors({
  ...
  try {
    ...
    return chunkB34S64RC_cjs.handleError(error, "Error upserting vectors");
  }
}
async function createIndex({
  ...
  try {
    ...
    return chunkB34S64RC_cjs.handleError(error, "Error creating index");
  }
}
async function queryVectors({
  ...
  try {
    ...
    return chunkB34S64RC_cjs.handleError(error, "Error querying vectors");
  }
}
async function listIndexes({ mastra, vectorName }) {
  try {
    ...
    return chunkB34S64RC_cjs.handleError(error, "Error listing indexes");
  }
}
async function describeIndex({
  ...
  try {
    ...
    return chunkB34S64RC_cjs.handleError(error, "Error describing index");
  }
}
async function deleteIndex({
  ...
  try {
    ...
    return chunkB34S64RC_cjs.handleError(error, "Error deleting index");
  }
}
...
var UPSERT_VECTORS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
  path: "/vector/:vectorName/upsert",
  responseType: "json",
  pathParamSchema: chunkQKOLB27L_cjs.vectorNamePathParams,
  bodySchema: chunkQKOLB27L_cjs.upsertVectorsBodySchema,
  responseSchema: chunkQKOLB27L_cjs.upsertVectorsResponseSchema,
...
var CREATE_INDEX_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
  path: "/vector/:vectorName/create-index",
  responseType: "json",
  pathParamSchema: chunkQKOLB27L_cjs.vectorNamePathParams,
  bodySchema: chunkQKOLB27L_cjs.createIndexBodySchema,
  responseSchema: chunkQKOLB27L_cjs.createIndexResponseSchema,
...
var QUERY_VECTORS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
  path: "/vector/:vectorName/query",
  responseType: "json",
  pathParamSchema: chunkQKOLB27L_cjs.vectorNamePathParams,
  bodySchema: chunkQKOLB27L_cjs.queryVectorsBodySchema,
  responseSchema: chunkQKOLB27L_cjs.queryVectorsResponseSchema,
...
var LIST_INDEXES_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/vector/:vectorName/indexes",
  responseType: "json",
  pathParamSchema: chunkQKOLB27L_cjs.vectorNamePathParams,
  responseSchema: chunkQKOLB27L_cjs.listIndexesResponseSchema,
...
var DESCRIBE_INDEX_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/vector/:vectorName/indexes/:indexName",
  responseType: "json",
  pathParamSchema: chunkQKOLB27L_cjs.vectorIndexPathParams,
  responseSchema: chunkQKOLB27L_cjs.describeIndexResponseSchema,
...
var DELETE_INDEX_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "DELETE",
  path: "/vector/:vectorName/indexes/:indexName",
  responseType: "json",
  pathParamSchema: chunkQKOLB27L_cjs.vectorIndexPathParams,
  responseSchema: chunkQKOLB27L_cjs.deleteIndexResponseSchema,
...
var LIST_VECTORS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/vectors",
  responseType: "json",
  responseSchema: chunkQKOLB27L_cjs.listVectorsResponseSchema,
...
var LIST_EMBEDDERS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/embedders",
  responseType: "json",
  responseSchema: chunkQKOLB27L_cjs.listEmbeddersResponseSchema,
  ...
  handler: async () => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error listing embedders");
    }
  }
});
...
//# sourceMappingURL=chunk-JN4QR7QO.cjs.map
//# sourceMappingURL=chunk-JN4QR7QO.cjs.map