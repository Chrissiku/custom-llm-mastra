...
var LIST_SCORERS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/scores/scorers",
  responseType: "json",
  responseSchema: chunkYZFZHEHC_cjs.listScorersResponseSchema,
...
var GET_SCORER_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/scores/scorers/:scorerId",
  responseType: "json",
  pathParamSchema: chunkYZFZHEHC_cjs.scorerIdPathParams,
  responseSchema: chunkYZFZHEHC_cjs.scorerEntrySchema.nullable(),
...
var LIST_SCORES_BY_RUN_ID_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/scores/run/:runId",
  responseType: "json",
  pathParamSchema: chunkEES2ZZGL_cjs.runIdSchema,
  queryParamSchema: chunkYZFZHEHC_cjs.listScoresByRunIdQuerySchema,
  responseSchema: chunkYZFZHEHC_cjs.scoresWithPaginationResponseSchema,
  ...
  handler: async ({ mastra, runId, ...params }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error getting scores by run id");
    }
  }
});
var LIST_SCORES_BY_SCORER_ID_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/scores/scorer/:scorerId",
  responseType: "json",
  pathParamSchema: chunkYZFZHEHC_cjs.scorerIdPathParams,
  queryParamSchema: chunkYZFZHEHC_cjs.listScoresByScorerIdQuerySchema,
  responseSchema: chunkYZFZHEHC_cjs.scoresWithPaginationResponseSchema,
  ...
  handler: async ({ mastra, scorerId, ...params }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error getting scores by scorer id");
    }
  }
});
var LIST_SCORES_BY_ENTITY_ID_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/scores/entity/:entityType/:entityId",
  responseType: "json",
  pathParamSchema: chunkYZFZHEHC_cjs.entityPathParams,
  queryParamSchema: chunkYZFZHEHC_cjs.listScoresByEntityIdQuerySchema,
  responseSchema: chunkYZFZHEHC_cjs.scoresWithPaginationResponseSchema,
  ...
  handler: async ({ mastra, entityId, entityType, ...params }) => {
    try {
      ...
      if (entityType === "AGENT") {
        const agent = await chunkHUWHY7SC_cjs.getAgentFromSystem({ mastra, agentId: entityId });
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error getting scores by entity id");
    }
  }
});
var SAVE_SCORE_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
  path: "/scores",
  responseType: "json",
  bodySchema: chunkYZFZHEHC_cjs.saveScoreBodySchema,
  responseSchema: chunkYZFZHEHC_cjs.saveScoreResponseSchema,
  summary: "Save score",
  ...
  handler: async ({ mastra, ...params }) => {
    try {
      ...
      return chunkB34S64RC_cjs.handleError(error, "Error saving score");
    }
  }
});
...
//# sourceMappingURL=chunk-KG5RK6PO.cjs.map
//# sourceMappingURL=chunk-KG5RK6PO.cjs.map