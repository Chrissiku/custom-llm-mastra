import { LIST_AGENT_VERSIONS_ROUTE, CREATE_AGENT_VERSION_ROUTE, GET_AGENT_VERSION_ROUTE, ACTIVATE_AGENT_VERSION_ROUTE, RESTORE_AGENT_VERSION_ROUTE, DELETE_AGENT_VERSION_ROUTE, COMPARE_AGENT_VERSIONS_ROUTE } from '../../handlers/agent-versions.js';
import { LIST_STORED_AGENTS_ROUTE, GET_STORED_AGENT_ROUTE, CREATE_STORED_AGENT_ROUTE, UPDATE_STORED_AGENT_ROUTE, DELETE_STORED_AGENT_ROUTE, PREVIEW_INSTRUCTIONS_ROUTE } from '../../handlers/stored-agents.js';
 ...
 */
export declare const STORED_AGENTS_ROUTES: readonly ServerRoute[];
/**
