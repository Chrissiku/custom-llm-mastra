...
function schemaToJsonSchema(schema) {
  ...
  const standardSchema = chunkEGSCXVMR_cjs.toStandardSchema5(schema);
  return chunkEGSCXVMR_cjs.standardSchemaToJSONSchema(standardSchema);
}
...
function looksLikeProcessorStepSchema(schema) {
  ...
  try {
    const jsonSchema = chunkEGSCXVMR_cjs.standardSchemaToJSONSchema(chunkEGSCXVMR_cjs.toStandardSchema5(schema));
...
//# sourceMappingURL=chunk-WC4OPIB4.cjs.map
//# sourceMappingURL=chunk-WC4OPIB4.cjs.map