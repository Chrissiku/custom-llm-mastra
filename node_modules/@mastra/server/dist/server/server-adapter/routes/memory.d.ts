export declare const MEMORY_ROUTES: readonly [import(".").ServerRoute<{
...
}, import("zod/v4/core").$strip>>, "POST", "/memory/observational-memory/buffer-status">, import(".").ServerRoute<import(".").InferParams<undefined, import("zod").ZodObject<{
    ...
    workingMemoryTemplate: import("zod").ZodUnknown;
