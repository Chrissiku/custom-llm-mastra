 ...
 */
export declare function generateOpenAPIDocument(routes: readonly ServerRoute[], info: {
    title: string;
    version: string;
    description?: string;
}): any;
