...
function createNewRoute(def, config) {
  ...
  return chunkEGSCXVMR_cjs.createRoute({
    ...def,
    ...schemas,
    responseType: "json",
    tags: ["Observability"],
    ...
    handler: (async (params) => {
      ...
      try {
        ...
        return chunkB34S64RC_cjs.handleError(error, `Error calling: '${def.summary.toLocaleLowerCase()}'`);
      }
    })
  });
}
...
//# sourceMappingURL=chunk-OV2TAONK.cjs.map
//# sourceMappingURL=chunk-OV2TAONK.cjs.map