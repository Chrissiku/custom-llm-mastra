...
var LIST_DATASETS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/datasets",
  responseType: "json",
  queryParamSchema: chunkUKMRQ6ER_cjs.paginationQuerySchema,
  responseSchema: chunkUKMRQ6ER_cjs.listDatasetsResponseSchema,
...
var CREATE_DATASET_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
  path: "/datasets",
  responseType: "json",
  bodySchema: chunkUKMRQ6ER_cjs.createDatasetBodySchema,
  responseSchema: chunkUKMRQ6ER_cjs.datasetResponseSchema,
...
var GET_DATASET_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/datasets/:datasetId",
  responseType: "json",
  pathParamSchema: chunkUKMRQ6ER_cjs.datasetIdPathParams,
  responseSchema: chunkUKMRQ6ER_cjs.datasetResponseSchema.nullable(),
...
var UPDATE_DATASET_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "PATCH",
  path: "/datasets/:datasetId",
  responseType: "json",
  pathParamSchema: chunkUKMRQ6ER_cjs.datasetIdPathParams,
  bodySchema: chunkUKMRQ6ER_cjs.updateDatasetBodySchema,
  responseSchema: chunkUKMRQ6ER_cjs.datasetResponseSchema,
...
var DELETE_DATASET_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "DELETE",
  path: "/datasets/:datasetId",
  responseType: "json",
  pathParamSchema: chunkUKMRQ6ER_cjs.datasetIdPathParams,
...
var LIST_ITEMS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/datasets/:datasetId/items",
  responseType: "json",
  pathParamSchema: chunkUKMRQ6ER_cjs.datasetIdPathParams,
  queryParamSchema: chunkUKMRQ6ER_cjs.listItemsQuerySchema,
  responseSchema: chunkUKMRQ6ER_cjs.listItemsResponseSchema,
...
var ADD_ITEM_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
  path: "/datasets/:datasetId/items",
  responseType: "json",
  pathParamSchema: chunkUKMRQ6ER_cjs.datasetIdPathParams,
  bodySchema: chunkUKMRQ6ER_cjs.addItemBodySchema,
  responseSchema: chunkUKMRQ6ER_cjs.datasetItemResponseSchema,
...
var GET_ITEM_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/datasets/:datasetId/items/:itemId",
  responseType: "json",
  pathParamSchema: chunkUKMRQ6ER_cjs.datasetAndItemIdPathParams,
  responseSchema: chunkUKMRQ6ER_cjs.datasetItemResponseSchema.nullable(),
...
var UPDATE_ITEM_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "PATCH",
  path: "/datasets/:datasetId/items/:itemId",
  responseType: "json",
  pathParamSchema: chunkUKMRQ6ER_cjs.datasetAndItemIdPathParams,
  bodySchema: chunkUKMRQ6ER_cjs.updateItemBodySchema,
  responseSchema: chunkUKMRQ6ER_cjs.datasetItemResponseSchema,
...
var DELETE_ITEM_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "DELETE",
  path: "/datasets/:datasetId/items/:itemId",
  responseType: "json",
  pathParamSchema: chunkUKMRQ6ER_cjs.datasetAndItemIdPathParams,
...
var LIST_ALL_EXPERIMENTS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  ...
  responseType: "json",
  queryParamSchema: chunkUKMRQ6ER_cjs.paginationQuerySchema,
  responseSchema: chunkUKMRQ6ER_cjs.listExperimentsResponseSchema,
...
var EXPERIMENT_REVIEW_SUMMARY_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  ...
  responseType: "json",
  responseSchema: chunkUKMRQ6ER_cjs.reviewSummaryResponseSchema,
...
var TRIGGER_EXPERIMENT_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
  path: "/datasets/:datasetId/experiments",
  responseType: "json",
  pathParamSchema: chunkUKMRQ6ER_cjs.datasetIdPathParams,
  bodySchema: chunkUKMRQ6ER_cjs.triggerExperimentBodySchema,
  responseSchema: chunkUKMRQ6ER_cjs.experimentSummaryResponseSchema,
...
var GET_EXPERIMENT_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/datasets/:datasetId/experiments/:experimentId",
  responseType: "json",
  pathParamSchema: chunkUKMRQ6ER_cjs.datasetAndExperimentIdPathParams,
  responseSchema: chunkUKMRQ6ER_cjs.experimentResponseSchema.nullable(),
...
var LIST_EXPERIMENT_RESULTS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/datasets/:datasetId/experiments/:experimentId/results",
  responseType: "json",
  pathParamSchema: chunkUKMRQ6ER_cjs.datasetAndExperimentIdPathParams,
  queryParamSchema: chunkUKMRQ6ER_cjs.paginationQuerySchema,
  responseSchema: chunkUKMRQ6ER_cjs.listExperimentResultsResponseSchema,
...
var UPDATE_EXPERIMENT_RESULT_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "PATCH",
  path: "/datasets/:datasetId/experiments/:experimentId/results/:resultId",
  responseType: "json",
  pathParamSchema: chunkUKMRQ6ER_cjs.experimentResultIdPathParams,
  bodySchema: chunkUKMRQ6ER_cjs.updateExperimentResultBodySchema,
  responseSchema: chunkUKMRQ6ER_cjs.experimentResultResponseSchema,
...
var COMPARE_EXPERIMENTS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
  path: "/datasets/:datasetId/compare",
  responseType: "json",
  pathParamSchema: chunkUKMRQ6ER_cjs.datasetIdPathParams,
  bodySchema: chunkUKMRQ6ER_cjs.compareExperimentsBodySchema,
  responseSchema: chunkUKMRQ6ER_cjs.comparisonResponseSchema,
...
var LIST_DATASET_VERSIONS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/datasets/:datasetId/versions",
  responseType: "json",
  pathParamSchema: chunkUKMRQ6ER_cjs.datasetIdPathParams,
  queryParamSchema: chunkUKMRQ6ER_cjs.paginationQuerySchema,
  responseSchema: chunkUKMRQ6ER_cjs.listDatasetVersionsResponseSchema,
...
var LIST_ITEM_VERSIONS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/datasets/:datasetId/items/:itemId/history",
  responseType: "json",
  pathParamSchema: chunkUKMRQ6ER_cjs.datasetAndItemIdPathParams,
  responseSchema: chunkUKMRQ6ER_cjs.listItemVersionsResponseSchema,
...
var GET_ITEM_VERSION_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "GET",
  path: "/datasets/:datasetId/items/:itemId/versions/:datasetVersion",
  responseType: "json",
  pathParamSchema: chunkUKMRQ6ER_cjs.datasetItemVersionPathParams,
  responseSchema: chunkUKMRQ6ER_cjs.datasetItemResponseSchema.nullable(),
...
var BATCH_INSERT_ITEMS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
  path: "/datasets/:datasetId/items/batch",
  responseType: "json",
  pathParamSchema: chunkUKMRQ6ER_cjs.datasetIdPathParams,
  bodySchema: chunkUKMRQ6ER_cjs.batchInsertItemsBodySchema,
  responseSchema: chunkUKMRQ6ER_cjs.batchInsertItemsResponseSchema,
...
var BATCH_DELETE_ITEMS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "DELETE",
  path: "/datasets/:datasetId/items/batch",
  responseType: "json",
  pathParamSchema: chunkUKMRQ6ER_cjs.datasetIdPathParams,
  bodySchema: chunkUKMRQ6ER_cjs.batchDeleteItemsBodySchema,
  responseSchema: chunkUKMRQ6ER_cjs.batchDeleteItemsResponseSchema,
...
var GENERATE_ITEMS_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
  path: "/datasets/:datasetId/generate-items",
  responseType: "json",
  pathParamSchema: chunkUKMRQ6ER_cjs.datasetIdPathParams,
  bodySchema: chunkUKMRQ6ER_cjs.generateItemsBodySchema,
  responseSchema: chunkUKMRQ6ER_cjs.generateItemsResponseSchema,
...
var CLUSTER_FAILURES_ROUTE = chunkEGSCXVMR_cjs.createRoute({
  method: "POST",
  path: "/datasets/cluster-failures",
  responseType: "json",
  bodySchema: chunkUKMRQ6ER_cjs.clusterFailuresBodySchema,
  responseSchema: chunkUKMRQ6ER_cjs.clusterFailuresResponseSchema,
...
//# sourceMappingURL=chunk-ILAUCYCE.cjs.map
//# sourceMappingURL=chunk-ILAUCYCE.cjs.map